...
const TechnologyCard = ({
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
      {/* Top */}
      ...
      {/* Name */}
      <h2 className="text-base font-bold text-[#0F172A]">{technology.name}</h2>

      {/* Description */}
      <p className="mt-2 min-h-[52px] text-[11px] leading-5 text-gray-500">
